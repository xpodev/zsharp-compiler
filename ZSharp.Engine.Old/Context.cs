...
[assembly: ZSharp.OldCore.LanguageEngine(typeof(ZSharp.Engine.Context))]

namespace ZSharp.Engine
{
    public class Context : OldCore.ILanguageEngine
    {
        private Dictionary<OldCore.DocumentInfo, SearchScope> _documentScopes = new();
        ...
        public OldCore.IParser GetParser() => _parser;
        ...
        public OldCore.IExpressionProcessor NextProcessor()
        {
        ...
        public void BeginDocument(OldCore.DocumentInfo document)
        {
        ...
        public IEnumerator<OldCore.IExpressionProcessor> GetEnumerator()
        {
